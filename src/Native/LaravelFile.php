...
{
    /**
     * Dynamically handle method calls to the File facade.
     *
    ...
    {
        // Check if the method exists in the File facade.
        if (method_exists(FileFacade::class, $method)) {
            // Call the method statically and return the result.
            return FileFacade::$method(...$arguments);
        } else {
